...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    def distance_helper(city1, city2):
        return (get_lat(city1) - get_lat(city2)) ** 2 + (get_lon(city1) - get_lon(city2)) ** 2
    return sqrt(distance_helper(city1, city2))
...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    coordinates = make_city('coordinate', lat, lon)
    if distance(coordinates, city1) < distance(coordinates, city2):
