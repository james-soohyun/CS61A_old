...
def free_bacon(score):
    ...
    return max(sub(mul(tens, 2),ones), 1)
    # END PROBLEM 2
...
def is_swap(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    def abs_difference(score):
        if score >= 100:
            score-=100
        tens, ones = score//10, score%10
        return abs(sub(tens,ones))
    return abs_difference(player_score) == abs_difference(opponent_score)
    # END PROBLEM 4
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    max_score, current_dice, best_dice = 0, 10, 0
    while current_dice > 0:
        average_score = make_averaged(roll_dice)(current_dice, dice)
